...
Do Case
    ...
    Case _cTipo == "PP001"	//  Agencia e Conta Corrente Favorecido
       ...
       If SA2->A2_BANCO == "341"
          _cRetorno := "0"+strzero(val(substr(SA2->A2_AGENCIA,1,4)),4)+" "+"000000"
          _cRetorno += strzero(val(substr(_cConta,6,5)),6)+" "+Left(SA2->A2_DVCTA,1)                               
       Else
    ...
    Case _cTipo == "PT001"	                           
         ...
         ElseIf SEA->EA_MODELO == "25"  .or. SEA->EA_MODELO == "26" .or. SEA->EA_MODELO == "27" 
             ...
             If SEA->EA_MODELO == "25"
                _cRetorno += CVALTOCHAR(SE2->E2_ZZOPCAO)
            Else
