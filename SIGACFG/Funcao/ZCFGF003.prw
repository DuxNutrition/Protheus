...
/*/{Protheus.doc} ZCFGF003
Manutenção dos Acessos x Rotinas (Dux)
@type function
@version 12.1.2310
...
User function ZCFGF003()
    ...
    oBrowse:SetDescription('Manutenção dos Acessos x Rotinas (Dux)')
...
@author Dux | Evandro Mariano
@since 05/09/2024
@return logical, aRotina do Menu
/*/
...
@author Dux | Evandro Mariano
@since 05/09/2024
@return logical, model da rotina
/*/
Static Function ModelDef()
    ...
    oModel:SetDescription( 'Manutenção dos Acessos x Rotinas (Dux)' )

    // Adiciona a descricao do Componente do Modelo de Dados
    oModel:GetModel( 'SZXMASTER' ):SetDescription( 'Manutenção dos Acessos x Rotinas (Dux)' )
...
@author Dux | Evandro Mariano
@since 05/09/2024
@return logical, oView da rotina
/*/
...
/*/{Protheus.doc} ZSeekSZX
Faz a busca para validação
@type function
@version 12.1.2310
@author Dux | Evandro Mariano
@since 05/09/2024
@param cRotina, character, descricao
@param cId, character, id
@param nOperation, numeric, operacao
@return logical, .T. or .F.
/*/
...
/*/{Protheus.doc} ZCopySZX
Faz a copia do usuario
@type function
@version 12.1.2310
@author Dux | Evandro Mariano
@since 05/09/2024
