...
Local lIpiDev   	:= GetNewPar("MV_IPIDEV",.F.)   	        //Apenas para devoluï¿½ï¿½o de compra de IPI (nota de saï¿½da). T-Sï¿½ra gerado na tag vIPI e destacado no campo//VALOR IPI do cabeï¿½alho do danfe. F-Serï¿½ gerado na tag vIPIDevol e destacado nas informaï¿½ï¿½es complementares do danfe.
Local lIPIOutro 	:= GetNewPar("MV_IPIOUT",.F.) .And. lIpiDev //Quando habilitado juntamente com o MV_IPIDEV, o valor do IPI serï¿½ gerado na tag vOutro, destacado nas informaï¿½ï¿½es complementares e no campo OUTRAS DESPESAS ACESSORIAS.

Local lEipiDev   	:= GetNewPar("MV_EIPIDEV",.F.)
Local lEIPIOutro 	:= GetNewPar("MV_EIPIOUT",.F.) .And. lEipiDev //Quando habilitado juntamente com o MV_EIPIDEV, o valor do IPI serï¿½ gerado na tag vOutro, destacado nas informaï¿½ï¿½es complementares e no campo OUTRAS DESPESAS ACESSORIAS.

Local lIpiBenef		:= GetNewPar("MV_IPIBENE",.F.) 				   //Nota de saï¿½da de retorno com tipo = Beneficiamento. .T.- Serï¿½ gerado na tag vOutro e destacado nas informaï¿½ï¿½es//complementares do danfe e no campo OUTRAS DESPESAS ACESSORIAS. .F. - Sï¿½ra gerado na tag vIPI e destacado no campo//VALOR IPI do cabeï¿½alho do danfe (procedimento padrï¿½o)
Local lIPIOutB 	    := GetNewPar("MV_IPIOUTB",.F.) .And. lIpiBenef //Quando habilitado juntamente com o MV_IPIBENE, o valor do IPI serï¿½ gerado na tag vOutro, destacado nas informaï¿½ï¿½es complementares e no campo OUTRAS DESPESAS ACESSORIAS.
...
Local lDevSimpl		:= GetNewPar("MV_DEVSIMP",.F.)	//Define se sera gravado no XML o valor e base de ICMS para nf de devolucao do Simples nacional. (Padrao F - nï¿½o leva)
...
Local lVeicNovo     := .F.
Local lInssFunRu	:=  SuperGetMV("MV_INSSFUN",,.F.) //Verifica se deve ser montado a Tag do INSS para Produtor Rural quando hï¿½ tributo retido
...
Local nValOutr		:= 0
Local cTpOrig 		:= ""
Local lDescIss		:= SuperGetMV("MV_DESCISS",,.F.) //Informa ao sistema se o ISS devera ser descontado do valor do titulo financeiro caso o cliente for responsï¿½vel pelo recolhimento.
Local lTpabiss		:= SuperGetMV("MV_TPABISS",,"2") == "1"//Se parï¿½metro igual a 1 indica se serï¿½ efetuado um desconto na duplicata quando o cliente recolhe ISS se igual a 2 serï¿½ gerado um titulo de abatimento.
...
Local lNCMOk		:= .F.
Local lAchou		:= .F.
Local lSomaPISST	:= .F. // Define se o valor de PISST deverï¿½ compor o valor total da nota
Local lSomaCOFINSST := .F. // Define se o valor de COFINSST deverï¿½ compor o valor total da nota
...
local cDesc99		:= "" //Descriï¿½ï¿½o da forma de pagamento quando 99 - outros faturamento
...
Private lCustoEntr	:= .F.	//Tratamento para atender o DECRETO Nï¿½ 35.679, de 13 de Outubro de 2010 - Pernambuco para o Ramo de Auto Peï¿½as
Private lDifal		:= .F.
Private lDifer		:= .F.
...
If cTipo == "1"
	//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ä¿
	//ï¿½Verifica se existem mais de um cupom relacionado na nota sobre cupom    ï¿½
	//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
	
	//Para usar a funï¿½ï¿½o do loja LjR30Sped ja tem que estar posicionado na SF2 
		...
		If MsSeek(xFilial("SF2")+cNota+cSerie+cClieFor+cLoja)
					...
					If FunName() == "SPEDNFSE" //.Or. FunName() == "SPEDCTE"
						...
						If SF3->F3_TIPO =="S"
							aadd(aISSQN,;
										...
										SF3->F3_BASEICM,;
										cSitTrib,;
										(cAliasSD2)->D2_BASEISS,; //Valor Base de Cï¿½lculo
			...
			Else
				...
				If !SF2->F2_TIPO $ "DB" 
					...
					a) Para operaï¿½ï¿½es interestaduais (UF do emitente diferente da UF do Cliente de Entrega) e o CNPJ do Destinatario(Cliente - F2_CLIENTE)
					...
					b) Para operaï¿½ï¿½es internas (UF do emitente igual a UF do Cliente de Entrega) e se o CNPJ do Destinatï¿½rio(Cliente - F2_CLIENTE)
					...
					If !lUsaCliEnt
						...
						Else
							If !Empty(cCliNota+cCliLoja)
								SA1->(MsSeek(xFilial("SA1")+cCliNota+cCliLoja))   //Busca os dados do cliente da Nota sobre Cupom para montar os dados do destinatï¿½rio do XML
							Else
								SA1->(MsSeek(xFilial("SA1")+SF2->F2_CLIENTE+SF2->F2_LOJA))
							EndIf
						EndIf
				...
				If GetNewPar("MV_SUFRAMA",.F.) .And. !empty(aDest[15])
					cMensFis += "Cï¿½digo Suframa: "+alltrim(aDest[15])+"." 
				Endif
				...
				//Verifica se ï¿½ uma venda de origem do Venda Direta ou SIGALOJA
				dbSelectArea("SL1")
				...
				If !Empty(SF2->F2_DUPL)	.Or. lVLojaDir
					...
					If lVLojaDir
						//Verifica se ï¿½ venda com Entrega ou Retira Posterior, pois pode ter ocorrido em outra filial.
						If !Empty(SL1->L1_ORCRES)
							cFilTit := xFilial("SE1",SL1->L1_FILRES)
							SL1->(DbSetOrder(1)) //L1_FILIAL + L1_NUM
							//Posiciona no Orï¿½amento Pai
				...
				If SD2->(FieldPos("D2_GRPCST"))<>0 //Grupo de tributaï¿½ï¿½o de ipi
				   cField  +=",D2_GRPCST"				    
				EndIf
				...
				While !Eof() .And. xFilial("SD2") == (cAliasSD2)->D2_FILIAL .And.;
					...
					If (cAliasSD2)->D2_TIPO == "D" 
						If SM0->M0_ESTENT == "PR" .And. (cAliasSD2)->D2_ICMSRET > 0
							...
							para atender a ICMS/PR 2017 (Decreto 7.871/2017) Art. 9, Seï¿½ï¿½o I, Anexo IX 
					...
					// Destacar ICMS prï¿½prio no XML quando MV_ICMDEVO = .F. e nota nï¿½o seja tipo Devoluï¿½ï¿½o - DSERTSS1-16233
					...
					If lContinua
						...
						If !Empty((cAliasSD2)->D2_NFORI)
										...
										Else
											dbSelectArea("SF3")
									   		...
									   		If MsSeek(xFilial("SF3")+SFT->FT_CLIEFOR+SFT->FT_LOJA+SFT->FT_NFISCAL+SFT->FT_SERIE)										   		
												...
												//A NF de saï¿½da Para este tipo de nota, o emitente eh sempre o sigamat.emp
							...
							Else
								...
								If MsSeek(xFilial("SD2")+(cAliasSD2)->D2_NFORI+(cAliasSD2)->D2_SERIORI)//+(cAliasSD2)->D2_CLIENTE+(cAliasSD2)->D2_LOJA+(cAliasSD2)->D2_COD+(cAliasSD2)->D2_ITEMORI)
									...
									EndIf
									//Obtem os dados de nota fiscal de produtor rural referenciada
									//A NF de saï¿½da NAO EH uma devolucao, portanto eh uma nota de saida complementar. Para este tipo
						...
						/* Caso F4_FORINFC seja utilizado para preenchimento do SPED C110 (C5_MENPAD+C5_MENNOTA)
							esse campo nï¿½o serï¿½ considerado para compor a mensagem complementar.
							Poderï¿½ ser utilizado o F4_FORMULA em seu lugar
						*/
						dbSelectArea("SM4")
						SM4->( DbSetOrder( 1 ))
						lC110 := .F.
						...
						/* O campo F4_FORINFC ï¿½ o substituto do F4_FORMULA e atravï¿½s do parï¿½metro MV_NFEMSF4 se determina 
						...
						*/
						...
						//Verifica se municipio de prestaï¿½ï¿½o foi informado no pedido
						If SC5->(FieldPos("C5_MUNPRES")) > 0 .And. !Empty(SC5->C5_MUNPRES)
						...
						//imposto dispensado na operaï¿½ï¿½o
						nDescRed := 0
						dbSelectArea("SFT")
						dbSetOrder(1)
						...
						If (cOrigem $"1-2-3-4-5-6-8" .And. (cCSTrib $ "00-10-20-30-40-41-50-51-60-70-90" .or. cCsosn2 $ "101-102-103-201-202-201-300-400-500-900"))
							If (cAliasSD2)->(FieldPos("D2_FCICOD")) > 0 .And. !Empty((cAliasSD2)->D2_FCICOD)
								...
								If lFCI
									cMsgFci	:= "Resolucao do Senado Federal nï¿½m. 13/12"
						...
						//ï¿½  ï¿½Cï¿½digo de Benefï¿½cio Fiscal na UF aplicado ao item
						...
						EndIf
						lCodLan := .F.
						If Upper(SM0->M0_ESTENT) $ cCodCST //TAG cBenef buscar o conteï¿½do da tabela 5.2 no sistema quando for do PR.
							dbSelectArea("CDV")
							...
							If MsSeek(xFilial("CDV") +'S'+PadR(cTpEspcBen,TamSX3("CDV_ESPECI")[1])+'S'+(cAliasSD2)->(D2_DOC+D2_SERIE+D2_CLIENTE+D2_LOJA+D2_ITEM))
								//Tratamento realizado enquanto o fiscal nï¿½o realiza a criaï¿½ï¿½o do campo na CDV
						...
						nValOutr  := 0
						// Outras despesas. Devoluï¿½ï¿½o com IPI. (Nota de compl.Ipi de uma devoluï¿½ï¿½o de compra(MV_IPIDEV=F) leva o IPI em voutros)
						...
						*/
						...
						aadd(aProd,	{Len(aProd)+1,;
							...
							cDescProd,;
							SB1->B1_POSIPI,;//Retirada validaï¿½ï¿½o do parametro MV_CAPPROD, de acordo com a NT2014/004 nï¿½o ï¿½ mais possï¿½vel informar o capï¿½tulo do NCM
							SB1->B1_EX_NCM,;
							cD2Cfop,;
							SB1->B1_UM,;
							(cAliasSD2)->D2_QUANT,;
							...
							(cAliasSD2)->D2_NUMLOTE,;//Numero do Lote
						   	nValOutr,;//Outras despesas. Devoluï¿½ï¿½o com IPI. (Nota de compl.Ipi de uma devoluï¿½ï¿½o de compra(MV_IPIDEV=F) leva o IPI em voutros)
							nRedBC,;//% Reduï¿½ï¿½o da Base de Cï¿½lculo
							cCST,;//Cï¿½d. Situaï¿½ï¿½o Tributï¿½ria
							IIF((SF4->F4_AGREG='N' .And. !AllTrim(SF4->F4_CF) $ cMVCfopTran) .Or. (SF4->F4_ISS='S' .And. SF4->F4_ICM='N'),"0","1"),;// Tipo de agregaï¿½ï¿½o de valor ao total do documento
							...
							IIF((cAliasSD2)->(FieldPos("D2_TOTIMP"))<>0,(cAliasSD2)->D2_TOTIMP,0),;   //aProd[30] - Total imposto carga tributï¿½ria. 
							...
							IIF((cAliasSD2)->(FieldPos("D2_TOTFED"))<>0,(cAliasSD2)->D2_TOTFED,0),;   //aProd[35] - Total carga tributï¿½ria Federal
							IIF((cAliasSD2)->(FieldPos("D2_TOTEST"))<>0,(cAliasSD2)->D2_TOTEST,0),;   //aProd[36] - Total carga tributï¿½ria Estadual
							IIF((cAliasSD2)->(FieldPos("D2_TOTMUN"))<>0,(cAliasSD2)->D2_TOTMUN,0),;   //aProd[37] - Total carga tributï¿½ria Municipal
						...
						*/
						...
						if DbSeek(xFilial("CDL")+(cAliasSD2)->D2_DOC+(cAliasSD2)->D2_SERIE+(cAliasSD2)->D2_CLIENTE+(cAliasSD2)->D2_LOJA)
							While !CDL->(Eof()) .And. CDL->CDL_FILIAL+CDL->CDL_DOC+CDL->CDL_SERIE+CDL->CDL_CLIENT+CDL->CDL_LOJA == xFilial("CDL")+(cAliasSD2)->D2_DOC+(cAliasSD2)->D2_SERIE+(cAliasSD2)->D2_CLIENTE+(cAliasSD2)->D2_LOJA
								If CDL->(FieldPos("CDL_PRODNF")) <> 0 .And. CDL->(FieldPos("CDL_ITEMNF")) <> 0 .And. AllTrim(CDL->CDL_PRODNF)+AllTrim(CDL->CDL_ITEMNF) == AllTrim((cAliasSD2)->D2_COD)+AllTrim((cAliasSD2)->D2_ITEM)
									...
									aAdd(aDados,{"NAT_EXP","Natureza", IIF(CDL->(FieldPos("CDL_NATEXP"))<>0, CDL->CDL_NATEXP ,"") }) //Adicionado para utilizar na verificaï¿½ï¿½o da montagem das tags do grupo de exportaï¿½ï¿½o indireta (I52 - exportind) substituindo o I53 - nRE
						...
						While CD2->(!Eof()) .And. xFilial("CD2") == CD2->CD2_FILIAL .And.;
							...
							Do Case
								Case AllTrim(CD2->CD2_IMP) == "ICM"
									...
									(cAliasSD2)->D2_COD} // Dux - Personalização - Para Tratar no PE
								...
								Case AllTrim(CD2->CD2_IMP) == "IPI"
									If !lConsig .or. lIpiOutr .or. ( cTPNota == "4" .and. lIpiDev ) //para alimentar vIPI na devoluï¿½ï¿½o
										...
										If (!lIpiDev .OR. lIPIOutro) .And. !(Alltrim((cAliasSD2)->D2_CF) $ cMVCFOPREM) .OR. ((cAliasSD2)->D2_TIPO=="B" .And. (lIpiBenef .OR. lIPIOutB))  
											...
											ElseIf ( (cAliasSD2)->D2_TIPO=="D" .And. !Empty(nValIPI) ).OR. ( (cAliasSD2)->D2_TIPO=="P" .And. lComplDev .And. !Empty(nValIPI) ) 
												...
												nValIPI := 0
												cNCM	:= ""
												aTail(aIPI) := {SB1->B1_SELOEN,SB1->B1_CLASSE,0,IIf(CD2->(FieldPos("CD2_GRPCST")) > 0 .and. !Empty(CD2->CD2_GRPCST),CD2->CD2_GRPCST,"999"),CD2->CD2_CST,0,IIF(CD2->CD2_PAUTA>0,CD2->CD2_QTRIB,0),CD2->CD2_PAUTA,0,0,CD2->CD2_MODBC,0,CD2->CD2_PAUTA/CD2->CD2_QTRIB,CD2->CD2_CODPRO} // Dux - Personalização - Para Tratar no PE
											EndIf 
										EndIf
								...
								Case AllTrim(CD2->CD2_IMP) == "PS2"
									If !lNfCupZero
										aTail(aPIS) := {CD2->CD2_CST,CD2->CD2_BC,CD2->CD2_ALIQ,CD2->CD2_VLTRIB,CD2->CD2_QTRIB,CD2->CD2_PAUTA,CD2->CD2_CODPRO } // Dux - Personalização - Para Tratar no PE
								...
								Case AllTrim(CD2->CD2_IMP) == "CF2"
									If !lNfCupZero
										aTail(aCOFINS) := {CD2->CD2_CST,CD2->CD2_BC,CD2->CD2_ALIQ,CD2->CD2_VLTRIB,CD2->CD2_QTRIB,CD2->CD2_PAUTA,CD2->CD2_CODPRO } // Dux - Personalização - Para Tratar no PE
								...
								Case AllTrim(CD2->CD2_IMP) == "PS3" .And. (cAliasSD2)->D2_VALISS==0
									If !lNfCupZero
										aTail(aPISST) := {CD2->CD2_CST,CD2->CD2_BC,CD2->CD2_ALIQ,CD2->CD2_VLTRIB,CD2->CD2_QTRIB,CD2->CD2_PAUTA,CD2->CD2_PSCFST,CD2->CD2_CODPRO } // Dux - Personalização - Para Tratar no PE
									Else
								...
								Case AllTrim(CD2->CD2_IMP) == "CF3" .And. (cAliasSD2)->D2_VALISS==0
										If !lNfCupZero
											aTail(aCOFINSST) := {CD2->CD2_CST,CD2->CD2_BC,CD2->CD2_ALIQ,CD2->CD2_VLTRIB,CD2->CD2_QTRIB,CD2->CD2_PAUTA,CD2->CD2_PSCFST,CD2->CD2_CODPRO } // Dux - Personalização - Para Tratar no PE
										Else
								...
								Case AllTrim(CD2->CD2_IMP) == "ISS" 
									...
									//
									//Conjunto de Alteraï¿½ï¿½es 229221 - Aline Yumi Kokumai - 21/05/2014 18:27:45 - Inclusï¿½o do fonte para manter o histï¿½rico.

									A condiï¿½ï¿½o da validaï¿½ï¿½o do Codigo do ISS passou a ser Verdadeira (.T.) 
									devido as rotinas do REINF ter comeï¿½ado a popular a tabela CDN causando
									erro em municipios especificos.
									Portanto serï¿½ mantido o legado da tabela CDN, porï¿½m para emissï¿½o de NF-e
									conjugada serï¿½ considerado o "Cï¿½digo de serviï¿½o da Nota fiscal eletï¿½nica" (SD2).
								...
								Case AllTrim(CD2->CD2_IMP) == "TST" 
									...
									aImp := {;
												IIF(SC5->C5_FRETAUT > 0,SC5->C5_FRETAUT,0),;		//vServ - Valor do Serviï¿½o
												IIf(SC5->(ColumnPos("C5_FRTCFOP")) > 0 .And. !Empty(SC5->C5_FRTCFOP) ,SC5->C5_FRTCFOP,""),; 	//CFOP
												IIf(!Empty(cMunTransp),cMunTransp,0),;				//cMunFG - Cï¿½digo do municï¿½pio de ocorrï¿½ncia do fato gerador do ICMS do transporte
												0,;			//CST - Nï¿½o utiliza no manual do contribuinte v6.00
												0,;			//MODBC - Nï¿½o utiliza no manual do contribuinte v6.00
												0,;			//PREDBC - Nï¿½o utiliza no manual do contribuinte v6.00
												nBCTot,;	//vBCRet - BC da Retenï¿½ï¿½o do ICMS 
												IIf(CD2->CD2_ALIQ > 0,CD2->CD2_ALIQ,0),;			//pICMSRet - Alï¿½quota da Retenï¿½ï¿½o
						...
						// Devoluï¿½ï¿½o de compra com IPI nï¿½o tributado
			...
			While !Eof() .And. xFilial("SD1") == (cAliasSD1)->D1_FILIAL .And.;
				...
				if SF4->F4_AJUSTE =="S" .and. aDest[1] == SM0->M0_CGC .and. (cAliasSD1)->(D1_TIPO) == "D" .and. (cAliasSD1)->D1_FORMUL == "S"
					...
					if SF2->(DbSeek(xFilial("SF2")+(cAliasSD1)->(D1_NFORI)+(cAliasSD1)->(D1_SERIORI))) 
						...
						if SA1->(DbSeek(xFilial("SA1")+(SF2->F2_CLIENTE)+(SF2->F2_LOJA)))
							...
							cMensCli += iIf (!Empty(SA1->A1_END),' ENDEREï¿½O: '+Rtrim(SA1->A1_END) ,'')
				...
				*/				
				...
				aadd(aProd,	{Len(aProd)+1,;  
					...
					nRedBC,;//% Reduï¿½ï¿½o da Base de Cï¿½lculo
					cCST,;//Cï¿½d. Situaï¿½ï¿½o Tributï¿½ria
					IIF(SF4->F4_AGREG<>'N' .And. SF4->F4_ISS='S',"1",IIF(SF4->F4_AGREG='N' .Or. (SF4->F4_ISS='S' .And. SF4->F4_ICM='N'),"0","1")),;// Tipo de agregaï¿½ï¿½o de valor ao total do documento
					cInfAdic,;//Informacoes adicionais do produto(B5_DESCNFE)
					nDescZF,;
					(cAliasSD1)->D1_TES,;
					"",;
					0,;
					0,;  // Da posiï¿½ï¿½o 28 a 30 tratamento realizado apenas para documento de saï¿½da por este motivo campos estï¿½o zerados e vazios.
					...
					IIF(SB1->(FieldPos("B1_CEST"))<>0,SB1->B1_CEST,""),; //aprod[41] NT2015/003
					IIF(SF4->(ColumnPos("F4_VENPRES"))>0,SF4->F4_VENPRES,""),; //aprod[42] utilizado para montar a tag indPres=1 para nota de devoluï¿½ï¿½o de venda
					nValIFecp ,; //aprod[43]  Valor do FECP. 
					cCodlan,; //aprod[44]  Cï¿½digo de Benefï¿½cio Fiscal na UF aplicado ao item .
					IIf(SB5->(ColumnPos("B5_2CODBAR")) > 0,IIf(Val(SB5->B5_2CODBAR)==0,"",StrZero(Val(SB5->B5_2CODBAR),Len(Alltrim(SB5->B5_2CODBAR)),0)),""),; //aprod[45]  Cï¿½digo de barra da segunda unidade de medida.
					IIf(SB1->(ColumnPos("B1_CODGTIN")) > 0,SB1->B1_CODGTIN,""),; //aprod[46] 
				...
				O array de retorno serï¿½ multimensional, trazendo na primeira posiï¿½ï¿½o o identificador (ID), 
				nasegunda posiï¿½ï¿½o a tag (o campo) e na terceira posiï¿½ï¿½o o conteï¿½do retornado do processo, 
					podendo ser um outro array com a mesma estrutura caso o ID possua abaixo de sua estrutura outros IDs.						 				
				*/
				aadd(aExp,{})
				...
				While !CD2->(Eof()) .And. xFilial("CD2") == CD2->CD2_FILIAL .And.;
					...
					If SubStr((cAliasSD1)->D1_CLASFIS,2,2) $ '51'	 .and. !Empty(SFT->FT_ICMSDIF)           .and. SFT->(ColumnPos("FT_VOPDIF")) > 0  .and. !Empty(SFT->FT_VOPDIF) .or.; // verifica diferimento com bloqueio de movimento
						...
						lDifer :=.T.
					Else
						lDifer := .F. //Reinicializaï¿½ï¿½o da variï¿½vel
					EndIf					
				...
				// Devoluï¿½ï¿½o de compra com IPI nï¿½o tributado apenas para saida
	...
	IF cVeramb >= "4.00"
	   //Ajute para alimentar o aDetPag
		...
		ElseIf (lVLojaDir .OR. !Empty(POSICIONE("SL1",2,xFilial("SL1")+SF2->F2_SERIE+SF2->F2_DOC,"L1_NUM"))) .And. cTipo == "1" .And. ( aRetPgLoj := LjGetPgNfe(cVerAmb) )[1]
			//Montagem do AdetPag quando venda for advindo do Venda Direta ou SigaLoja e condiï¿½ï¿½o de pagamento for = "CN"(Condicao Negociada)
			//Alem disso verifico se existem o registro na SL4, caso nï¿½o, mantenho o legado anterior
			aDetPag := aRetPgLoj[2]
		...
		Else		
			...
			if cTipo == "1"
				cDesc99	:= &(SuperGetMV("MV_MFATIPR",,'"Negociaï¿½ï¿½o Futura"')) //Descriï¿½ï¿½o da forma de pagamento quando 99 - outros faturamento 
			else
				cDesc99	:= &(SuperGetMV("MV_TPAGCOM",,'"Negociaï¿½ï¿½o Futura"')) //Descriï¿½ï¿½o da forma de pagamento quando 99 - outros compras
			endIf

			aadd(aDetPag, {cForma, aTotal[02]+aTotal[03], 0.00, "", "", "", "", Iif( cForma <> "90", cIndPag, "" ), cDesc99 } )   
		EndIf	
		
		//Exemplo de como gerar o Grupo Cobranï¿½a
		//aadd(aFat,{"Nï¿½mero da Fatura",Valor Original da Fatura,Valor do desconto,Valor Lï¿½quido da Fatura})   
...
IF lPe01Nfe     
	...
	If ( Len(aParam) >= 5 )
		...
		// DUX - Personalização
		//Devido a Aglutinação de Produtos
		//--Início
		aICMS		:= aParam[21]
		aIPI		:= aParam[22]
		aICMSST		:= aParam[23]
...
If !Empty(aNota)
	...
	If nValDifer > 0
		cMensCpl += "Diferimento do ICMS que exceder 12% - Base Legal Livro III, Art 1ï¿½-K do RICMS/RS alterado conforme Decreto 55797 de 17/03/2021. Valor do ICMS Diferido R$ " + ConvType(nValDifer,15,2) + "."
	EndIf
...
Local cIndicador	:= ""
Local cTipocli		:= ""
Local cChvDupli		:= ""											// Nï¿½o permitido gerar a mesma nota 
...
//DUX - INICIO
//Douglas Martins - ATOSDATA 26/05/2023
    cFunction := 'Random'
    IF Empty(cNumNf)
        cNumNf := iif(findFunction(cFunction ),alltrim(str(&cFunction.( 10000000, 99999999 ))),alltrim(str(Randomize( 10000000, 99999999 ))))
    EndIF
//DUX - FIM
cChave += cNumNf
...
If !Empty(aIEST) 
	...
	Regra de Validaï¿½ï¿½o
	Se informada a IE do Substituto Tributï¿½rio para uma operaï¿½ï¿½o com Exterior ou Operaï¿½ï¿½o Interna (tag:idDest=1 ou 3)
	Exceï¿½ï¿½o: A critï¿½rio da UF, poderï¿½ ser aceita a informaï¿½ï¿½o da IE-ST em operaï¿½ï¿½o interna.
	*/
	/* Adicionado tratativa para destacar em XML I.E. especial, para cliente ST, em operaï¿½ï¿½es internas no estado do PR, conforme Art. 176 ï¿½ 10 do RICMS 2017 */                                                                                                                                                                                                                                                       
...
Static Function NfeDest(aDest,cVerAmb,aTransp,aCST,lBrinde,cMunDest)
	...
	If ConvType(aDest[17]) <> "2" .and. !Empty(aDest[14])
		...
		EndIf
	Else
			cIndicador := "9" //9-Nï¿½o Contribuinte: a IE do destinatï¿½rio pode ser informada ou nï¿½o, jï¿½ que algumas UF concedem inscriï¿½ï¿½o estadual para nï¿½o contribuintes.
			//No caso de operaï¿½ï¿½o com o Exterior informar indIEDest=9 e nï¿½o informar a tag IE do destinatï¿½rio;
	...
	*/
	...
	EndIf
	if !lBrinde
		cString += NfeTag('<EMAIL>',AllTrim(aDest[16])+cMailTrans+';dux.centraliza@saastargetit.com.br')
	endif
...
Local lIssQn     	:= .F.
Local lMvPisCofD 	:= GetNewPar("MV_DPISCOF",.F.)   // Parï¿½metro para informar os valores de Cofins e Pis nas Informaï¿½ï¿½es complementares do Danfe 
//Local lSimpNac   	:= SuperGetMV("MV_CODREG")== "1" .Or. SuperGetMV("MV_CODREG")== "2" 
Local lUnTribCom	:= GetNewPar("MV_VTRICOM",.F.) //Parï¿½metro para informar o valor unitï¿½rio comercial e valor unitï¿½rio tributï¿½vel nas informaï¿½ï¿½es complementares do DANFE (quando vuncom e vuntrib forem diferentes)
Local lNContrICM	:= .F.  //Define se o cliente nï¿½o ï¿½ contribuinte do ICMS no estado.
Local lPesFisica	:= .F.
Local lDInoDanfe	:= GetNewPar("MV_DIDANFE",.F.) //Parï¿½metro para informar os dados da DI nas informaï¿½ï¿½es complementares do Xml/Danfe
Local lCalcMed 		:= GetNewPar("MV_STMEDIA",.F.) //Define se irï¿½ calcular a mï¿½dia do ICMS ST e da BASE do ICMS ST. 
Local lSuframa		:= GetNewPar("MV_SUFRAMA",.F.) // Parï¿½metro referente a Suframa
...
Local lNfCpm		:= .F.
Local cMVCFOPREM	:= AllTrim(GetNewPar("MV_CFOPREM",""))     	// Parï¿½metro que informa as CFOPs de Remessa para entrega Futura
Local cCfopVdOrd 	:= "5118, 6118, 5119, 6119, 5120, 6120" 	// CFOPï¿½s de Venda a ordem conforme NT2021.004 - v.1.34
...
//Tratamento para atender NT 2021.004 Alteraï¿½ï¿½es Introduzidas na Versï¿½o 1.34 -  Regra K01-20
...
If  !lIssQn    
		...
		If Len(aIcms)>0
			...
			Else
				If aCST[1] $ '51' .and. !Empty(aICMS[12]) .and. !lArt186
				    ...
				    /*Para CST=51, O Valor do ICMS(vICMS) nï¿½o serï¿½  a diferenï¿½a do Valor do ICMS da Operaï¿½ï¿½o (vICMSOp) e o Valor do ICMS diferido (vICMSDif),
					O valor serï¿½ do campo FT_ICMSDIF, caso de a rejeiï¿½ï¿½o 353-Valor do ICMS no CST=51 nï¿½o corresponde a diferenï¿½a do ICMS operaï¿½ï¿½o e ICMS diferido procurar o fiscal.*/
	...
	If Len(aIcmsST)>0	
		...
		/* NT 2020.005
			...
			O trecho abaixo deve ser liberado assim que houver liberaï¿½ï¿½o da ficha DSERFISE-1055

		If retNT2005() .And. (aCST[1] $ "10|70|90") .And. alltrim(aICMSST[17]) $ "3|9|12" //FT_MOTICMS - 3=Uso na agropecuï¿½ria | 9=Outros | 12=ï¿½rgï¿½o de fomento e desenvolvimento agropecuï¿½rio.
			cString	+= "<vICMSSTDeson>" + ConvType(aICMSST[12],15,2) + "</vICMSSTDeson>" // #TODO - Verificar com fiscal qual o campo serï¿½ salvo o ICMSST Desonerado
			...
			If nBaseIcm > 0 .and. nValICM > 0	.and. nAlqICM > 0
			    ...
			    If cArt274 == "1"  .And. IIF(!lEndFis,ConvType(SM0->M0_ESTCOB),ConvType(SM0->M0_ESTENT)) == "SP"
					...
					if Empty(At("Artigo 274 do RICMS", cMensFis))
						cMensFis += "Imposto Recolhido por Substituiï¿½ï¿½o - Artigo 274 do RICMS (Lei 6.374/89, art.67,Paragrafo 1o., e Ajuste SINIEF-4/93',clï¿½usa terceira, na redaï¿½ï¿½o do Ajuste SINIEF-1/94) &|"+ConvType(aProd[02])+"|"+AllTrim(str(IcmsCbr(aNota,aProd),15,2))+"|&"
					else
				...
				ElseIF cArt274 == "1"  .And. IIF(!lEndFis,ConvType(SM0->M0_ESTCOB),ConvType(SM0->M0_ESTENT)) == "PR"  
					if SF4->F4_CODIGO > "500"  /* TES de Saï¿½da */  
						//Decreto 6080/2012 com o Regulamento do ICMS estï¿½ revogado
						cMensFis += " Imposto Recolhido por Substituiï¿½ï¿½o - ART. 5ï¿½, II , ANEXO IX ,DO RICMS/PR DECRETO 7871/2017 - DOE PR de 02.10.2017, onde o 'Cod.Produto:  " +ConvType(aProd[02])+" '  Valor da Base de ST: R$ " +Alltrim(str(nBaseIcm,15,2))+" Valor de ICMS ST: R$ "+Alltrim(str(nValICM,15,2))+" "
					else //entrada
						cMensFis += " Imposto Recolhido por Substituiï¿½ï¿½o - ART. 5ï¿½, I  , ANEXO IX ,DO RICMS/PR DECRETO 7871/2017 - DOE PR de 02.10.2017, onde o 'Cod.Produto:  " +ConvType(aProd[02])+" '  Valor da Base de ST: R$ " +Alltrim(str(nBaseIcm,15,2))+" Valor de ICMS ST: R$ "+Alltrim(str(nValICM,15,2))+" "
					endif
					/* Conforme consulta realizado no chamado TIBIKO
					cMensFis += "Imposto Recolhido por Substituiï¿½ï¿½o - Artigo 471 do RICMS (Parï¿½grafo 1o, alï¿½nea B, inciso II, onde o 'Cod.Produto:  " +ConvType(aProd[02])+" ' Valor da Base de ST: R$ " +str(nBaseIcm,15,2)+" Valor de ICMS ST: R$ "+str(nValICM,15,2)+" "
					*/
				ElseIF cArt274 == "1"  .And. IIF(!lEndFis,ConvType(SM0->M0_ESTCOB),ConvType(SM0->M0_ESTENT)) == "SC"  
					...
					If !lPesFisica .And. !lNContrICM 
						cMensFis += "Imposto Retido por Substituiï¿½ï¿½o Tributï¿½ria - RICMS-SC/01 - Anexo 3. 'Cod.Produto: " +ConvType(aProd[02])+" '  Valor da Base de ST: R$ " +str(nBaseIcm,15,2)+"  Valor de ICMS ST: R$ "+str(nValICM,15,2)+" "
					EndIf	 	
				ElseIF cArt274 == "1"  .And. IIF(!lEndFis,ConvType(SM0->M0_ESTCOB),ConvType(SM0->M0_ESTENT)) == "AM"
				 	...
				 	If (lNContrICM .And. SA1->A1_EST <> "AM") .Or. SA1->A1_EST == "AM"  //Conforme consulta (TGVUIP).
				 		cMensFis += "Mercadoria jï¿½ tributada nas demais fases de comercializaï¿½ï¿½o - Convï¿½nio ou Protocolo ICMS nï¿½ "+Alltrim(aProd[28])+ ". Cod.Produto: " +ConvType(aProd[02])+"."
				 	EndIf
				
				ElseIF cArt274 == "1"  .And. IIF(!lEndFis,ConvType(SM0->M0_ESTCOB),ConvType(SM0->M0_ESTENT)) == "RS"			 
				 	if !Empty(aProd[28])				 	
				 		cMensFis += "Imposto recolhido por ST nos termos do (Convï¿½nio ou Protocolo ICMS nï¿½ "+ Alltrim(aProd[28]) +") RICMS-RS. Valor da Base de ICMS ST R$"+ cValToChar(nBaseIcm) +" e valor do ICMS ST R$ "+ cValToChar(nValICM) +". Cod.Produto: " +ConvType(aProd[02])+"." 
				 	else
				...
				ElseIf cArt274 == "1"  .And. IIF(!lEndFis,ConvType(SM0->M0_ESTCOB),ConvType(SM0->M0_ESTENT)) == "ES" .And. Len(aICMS) > 0 .And. ( nBaseIcm+nValICM > 0 )
					...
					cMensFis += "Imposto Recolhido por Substituiï¿½ï¿½o RICMS. Cod.Produto:  " +ConvType(aProd[02])+" Base de cï¿½lculo da retenï¿½ï¿½o - R$ " + Alltrim(str(nBaseIcm,15,2))+". " 
					cMensFis += "ICMS da operaï¿½ï¿½o prï¿½pria do contribuinte substituto - R$ "+Alltrim(str(aIcms[7],15,2))+". "
				...
				ElseIf cArt274 == "1"  .And. IIF(!lEndFis,ConvType(SM0->M0_ESTCOB),ConvType(SM0->M0_ESTENT)) == "MG" .And. Len(aICMS) > 0 .And. ( nBaseIcm+nValICM > 0 )  // Conforme Chamado TIABCS
					...
					If nTotProd == nItProd
						cMensFis += "Imposto Recolhido por Substituiï¿½ï¿½o - ICMS retido pelo cliente S.T. DECRETO 43708 19/12/2009."
				...
				ElseIf IIF(!lEndFis,ConvType(SM0->M0_ESTCOB),ConvType(SM0->M0_ESTENT)) == "SP" 
					If cIndFinal == "1"
						cMensFis += "Imposto Recolhido por Substituiï¿½ï¿½o - Contempla o artigo 313-Z19 do RICMS-SP."
					Else
						//Artigo somente para o estado de SP - DSERTSS1-6532
						//http://tdn.totvs.com.br/pages/releaseview.action?pageId=267795989
						cMensFis += "Imposto Recolhido por Substituiï¿½ï¿½o - Contempla os artigos 273, 313 do RICMS. Valor da Base de ST: R$ "+Alltrim(str(nBaseIcm,15,2))+" Valor de ICMS ST: R$ "+Alltrim(str(nValICM,15,2))+" "
					EndIf
				...
				ElseIf IIF(!lEndFis,ConvType(SM0->M0_ESTCOB),ConvType(SM0->M0_ESTENT)) == "RJ"
					if aComb[01] $ NfeProdANP()
						...
						cMensFis += "ICMS a ser repassado nos termos do Capï¿½tulo V do Convï¿½nio ICMS 110/07. Valor da Base de ST: R$ "+Alltrim(str(nBaseIcm,15,2))+" Valor de ICMS ST: R$ "+Alltrim(str(nValICM,15,2))+" "
					elseif cArt274 == "1"
	...
	If (cIdDest == "2" .and. cIndFinal == "1" .and. cIndIEDest == "9") .and. (Len(aISSQN)== 0) .and. ;
	   ...
	   (iif(Len(aComb) > 0 .And. !Empty(aComb[01]),aComb[01] $ NfeCodANP(),.T.))
		...
		If Len(aICMUFDest) > 0 .And. !(aNota[04] == "0" .and. aNota[5] == "N" .And. aICMUFDest[05] == 0)
			...
			// <AliquotaInter> padrï¿½o 4,7 ou 12. Em caso de pedido com produtos com aliquotas diferentes, as alï¿½quotas serï¿½o separadas em vï¿½rgula para exibiï¿½ï¿½o. (Ex.: 4.00%, 7.00%)
		...
		Elseif Len(aICMUFDest) == 0
			...
			/*Para os casos em que nï¿½o hï¿½ calculo de Difal na CD2( ICMS Isento), o grupo ICMSUFDEST deve ser gerado com valores zerados, para
			nï¿½o apresentar a rejeiï¿½ï¿½o 694: Nï¿½o informado o grupo de ICMS para a UF de destino [nItem:999].
			Apenas as tags pICMSUInter e pICMSInterPart devem ser geradas com valores para nï¿½o apresentar erro de schema
...
Else
	If Len(aISSQN)>0 .and. !Empty(aISSQN[01])
		...
		//cPais Cï¿½digo do Paï¿½s onde o serviï¿½o foi prestado
		//Tabela do BACEN. Informar somente se o municï¿½pio da prestaï¿½ï¿½o do serviï¿½o for "9999999".
		IF cMunPres == "9999999"
...
/*Nota Tï¿½cnica 004 de 2011 conforme chamado - THCTB4 */
/*Nota Tï¿½cnica 004 de 2011 conforme chamado - THCTB4 e conforme portaria nï¿½ 275/2009 do chamado TPIPVV */
...
Static Function NfeTotal(aTotal,aRet,aICMS,aICMSST,lIcmDevol,cVerAmb,aISSQN,nVicmsDeson,aNota,nVIcmDif,aAgrPis,aAgrCofins,nValLeite )
	...
	Local cString		:= ""
	Local cMVREGIESP	:= AllTrim(GetNewPar("MV_REGIESP","2"))	/*	1 ï¿½ Microempresa Municipal; 2 ï¿½ Estimativa; 3 ï¿½ Sociedade de Profissionais; 
																	4 ï¿½ Cooperativa; 5 ï¿½ Microempresï¿½rio Individual (MEI);
																	6 ï¿½ Microempresï¿½rio e Empresa de Pequeno Porte (ME EPP) */
	Local nX    := 0
	Local nBicm := 0
	LOcal nVicm := 0
	Local nBicmst := 0
	...
	cString += '<vNF>'+ConvType(aTotal[02]+aTotal[03],15,2)+'</vNF>' // PISST + COFINSST serï¿½o somados a vNF caso indSomaPISST = 1/indSomaCOFINSST = 1 NT 2020.005
...
Local nX := 0
Local cString := ""
Local lMVINTTRAN := SuperGetMV("MV_INTTRAN", ,.T.)  // Parametro que define se as tags <veicTransp> e <reboque>, seram geradas em operaï¿½ï¿½es internas.
Local lGeraTags	 := .T.
DEFAULT cMunDest	:= ""
DEFAULT aTransp := {}
DEFAULT aImp    := {}
...
If cVerAmb == "4.00"
	//Se operaï¿½ï¿½o interestadual(idDest=2), nï¿½o informar os Grupos Veiculo Transporte (id:X18; veicTransp) e Grupo Reboque (id: X22)
	//Obs1: a critï¿½rio de cada UF, a regra de validaï¿½ï¿½o acima tambï¿½m pode ser aplicada nas operaï¿½ï¿½es internas (idDest=1) se cMun (id:C10) do Emitente <> cMun (id: E10) do Destinatï¿½rio
...
If Len(aMotivoCont)>0
	//cString += ConvType("DANFE emitida em contingencia devido a problemas tï¿½cnicos - serï¿½ necessï¿½ria a substituiï¿½ï¿½o.",Len("DANFE emitida em contingencia devido a problemas tï¿½cnicos - serï¿½ necessï¿½ria a substituiï¿½ï¿½o."))+" "
	cString += "Motivo da contingencia: "+ConvType(aMotivoCont[1],Len(aMotivoCont[1]))+", com "
	cString += ConvType("inicï¿½o em",Len("inicï¿½o em"))+" "+StrZero(Day(aMotivoCont[2]),2)+"/"+StrZero(Month(aMotivoCont[2]),2)+"/"+StrZero(Year(aMotivoCont[2]),4)+" "
	cString += ConvType("ï¿½s",2)+" "+ConvType(aMotivoCont[3],Len(aMotivoCont[3]))+"."
EndIf 
If Len(cMsgCli)>0 .and. !Empty(cMsgCli)
	cString += ConvType(cMsgCli,Len(cMsgCli))+" "  
	//A Nota Fiscal de devoluï¿½ï¿½o deve ser preenchida com a nota e a data Original de acordo com a legislaï¿½ï¿½o:
	//Fundamento: Artigo 136 do RICMS-SP - O contribuinte,  excetuado o produtor,  emitirï¿½ Nota Fiscal (Lei nï¿½ 6374/89,  art. 67,  
	//Parï¿½grafo 1ï¿½,  e Convï¿½nio de 15.12.70 - SINIEF, arts. 54 e 56, na redaï¿½ï¿½o do Ajuste SINlEF- 3/94, clï¿½usula primeira, XII):.
			...
			Else
				if SM0->M0_ESTENT == 'SP' .And. !(aNfSa[5] $ "I/P/C") .And. !Empty(aNfVinc[nZ][13])
					...
					if (nPos := aScan(aDadosDest,{|x| x[1]+x[2]+x[10] == aNfVinc[nZ][12]+aNfVinc[nZ][13]+AllTrim(Str(aNfVinc[nZ][11])) }) ) == 0
						...
						cString += alltrim(aDadosDest[nPos,6]) + ', ' + alltrim(aDadosDest[nPos,7]) + ', inscrita no CNPJ sob nï¿½ ' + alltrim(aDadosDest[nPos,8]) + ' e Inscricao Estadual '
						cString += alltrim(aDadosDest[nPos,9]) + ' atraves das NFs: '
						lMsnOk:= .T.
					EndIf
					cString += "NF-e: "
				Else
					cString += "Emissï¿½o Original NF-e: "
				endIf
			endif
...
If Len( aRefECF ) > 0	 	//Nota de espï¿½cie ECF vinculada
...
If Len( aNfVincRur ) > 0 	//Nota de espï¿½cie NFP vinculada 
...
If nTotCrdP > 0 // valor de crï¿½dito Presumido -  Art.75, XXXII do RICMS/MG
	cString += "Valor de crï¿½dito Presumido: R$ " + AllTrim(Transform(nTotCrdP, "@ze 9,999,999,999,999.99")) + ". "
EndIf
...
If lCustoEntr
	cString += "ICMS apurado nos termos do Decreto nï¿½ 35.679, de 13 de Outubro de 2010."
EndIf
...
If nvFCPUFDest > 0 .or.  nvICMSUFDest > 0 .or. nvICMSUFRemet > 0 .or. nvBCUFDest  > 0     
    ...
    cString +="Valor da BC do ICMS na UF de destino: R$ "+ConvType(nvBCUFDest,15,2)+". "  
 		...
 		cString +="Alï¿½quota interna da UF de destino:  "+ConvType(npICMSUFDest)+"%. "                                                  //3  pICMSUFDest    nao
 		cString +="Alï¿½quota interestadual das UF envolvidas: "+cMensDifal+ ". "
 		cString +="Percentual provisï¿½rio de partilha do ICMS Interestadual: " +ConvType(npICMSIntP)+"%. "
...
ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ä¿ï¿½ï¿½
ï¿½ï¿½ï¿½Funï¿½ï¿½o    ï¿½MyGetEnd  ï¿½ Autor ï¿½ Liber De Esteban             ï¿½ Data ï¿½ 19/03/09 ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ä´ï¿½ï¿½
ï¿½ï¿½ï¿½Descriï¿½ï¿½o ï¿½ Verifica se o participante e do DF, ou se tem um tipo de endereco ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½          ï¿½ que nao se enquadra na regra padrao de preenchimento de endereco  ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½          ï¿½ por exemplo: Enderecos de Area Rural (essa verificï¿½ï¿½o e feita     ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½          ï¿½ atraves do campo ENDNOT).                                         ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½          ï¿½ Caso seja do DF, ou ENDNOT = 'S', somente ira retornar o campo    ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½          ï¿½ Endereco (sem numero ou complemento). Caso contrario ira retornar ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½          ï¿½ o padrao do FisGetEnd                                             ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ä´ï¿½ï¿½
ï¿½ï¿½ï¿½ Obs.     ï¿½ Esta funcao so pode ser usada quando ha um posicionamento de      ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½          ï¿½ registro, pois serï¿½ verificado o ENDNOT do registro corrente      ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ä´ï¿½ï¿½
ï¿½ï¿½ï¿½ Uso      ï¿½ SIGAFIS                                                           ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ù±ï¿½
ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½*/
...
//Valor Lï¿½quido
If SM0->M0_CODMUN == "3106200" .And. cTpPessoa == "EP"  // Tratamento realizado para o municipio de Belo Horizonte- MG quando o Tomador for ï¿½rgï¿½o Pï¿½blico
...
Local cCliFor		:= ""
Local cData		:= ""
Local cLocCQ    	:= PADR(SuperGetMV("MV_CQ"),TAMSX3("D7_LOCAL")[1])  //adequo o conteudo padrï¿½o "98" para "98 "
Local cLoja		:= ""
Local cNfiscal		:= ""
Local cNumCQ		:= ""
Local cNfOrig		:= ""
...
@param		cDestDanf  		//'1' Retorna a mensagem no campo "Informaï¿½ï¿½es Complementares"
...
Do Case
  ...
  //ï¿½ acompanhada do respectivo valor.
	Case cEstado== "MG"   // Tratamento legado de FECP
		If  cDestDanf =='1'
			cMensFcop := "Adicional de alï¿½quota - Fundo de Erradicaï¿½ï¿½o da Misï¿½ria - R$ " + Alltrim(Transform(nVfecp,"@E 999,999,999.99"))
	   EndIf
 	
	Case cEstado== "PR" 
		//PR: Arquivo "Decreto Nï¿½ 3.339, de 20 de janeiro de 2016 - FECOP a partir de 01-02-2016.doc", pï¿½gina 4:
    	//Art. 6ï¿½ - Na Nota Fiscal Eletrï¿½nica - NF-e, modelos 55 ou 65, emitida para acobertar as operaï¿½ï¿½es com os produtos de que trata o art. 1ï¿½, deverï¿½ constar:
    	//I - o valor numï¿½rico do FECOP referente a cada item, no campo "Informaï¿½ï¿½o Adicional do Produto", com o seguinte formato: ##FECOP<N.
    	//NN>##, onde N.NN ï¿½ o valor numï¿½rico do FECOP referente a cada item, com duas casas decimais, separadas por ponto, sem separador de milhar;
    	//II - o valor numï¿½rico do FECOP referente ao valor total, no campo "Informaï¿½ï¿½es Complementares", com o seguinte formato: ##FECOP<N.
    	//NN>##, onde N.NN ï¿½ o valor numï¿½rico do FECOP referente ao valor total, com duas casas decimais, separadas por ponto, sem separador de milhar.  cValToChar(nVfecp)  
		If  cDestDanf =='1' 
	...
	Case cEstado== "RJ"
    	If cDestDanf =='1'
			cMensFcop := "Adicional de alï¿½quota - Fundo Estadual de Combate ï¿½ Pobreza e ï¿½s Desigualdades Sociais (FECP) - R$ " + Alltrim(Transform(nVfecp,"@E 999,999,999.99"))
	    EndIf

	Case cEstado== "RS" 
		If  cDestDanf =='1'
	    	cMensFcop := "Adicional de alï¿½quota relativo ao AMPARA/RS, criado pela Lei nï¿½ 14.742/15 - R$ " + Alltrim(Transform(nVfecp,"@E 999,999,999.99")) 
		EndIf

	OtherWise
		IF cDestDanf =='1'
			cMensFcop  := "Adicional de alï¿½quota - Fundo Estadual de Combate ï¿½ Pobreza e ï¿½s Desigualdades Sociais  - R$" + Alltrim(Transform(nVfecp,"@E 999,999,999.99"))
		EndIf
	...
	If cDestDanf =='1' // Informaï¿½ï¿½o do fisco <infAdFisco> para fecp
			nBaseIcm:=0
			nValor  :=0
			nPerc   :=0
			For nX := 1 to Len( aICMS )
...
If  lIcmsST .And. lNCMOk
	cMsg +="Valor das operaï¿½ï¿½es sujeitas ao adicional:: R$  " + Alltrim( Str(nBaseST, 14, 2) ) 
	cMsg +=" O valor corresponde ï¿½ base de cï¿½lculo do ICMS ST"
EndIf
...
Static Function retUn2UM( lNoImp2UM, lImp2UM, cCFOPExp, cCFOP, cUMDIPI, cUM)
	...
	// Tratamento para notas de importaï¿½ï¿½o
...
Static Function retQtd2UM( lNoImp2UM, lImp2UM, cCFOPExp, cCFOP, nCONVDIP, nQUANT, cTpConv)
	...
	//O valor ï¿½ limitado a 4 casas decimais 
	...
	If !Empty(cCondPag)
		Do Case
			...
			Case cCondPag == "BOL" //BOLETO BANCARIO
				cForma := "15"
			Case cCondPag == "DB" //Depï¿½sito Bancï¿½rio
				cForma := "16"
			Case cCondPag == "PX" //Pagamento Instantï¿½neo (PIX)
				cForma := "17"
			Case cCondPag == "PD" //Transferï¿½ncia bancï¿½ria, Carteira Digital
				cForma := "18"
			Case cCondPag == "FID" //Programa de fidelidade, Cashback, Crï¿½dito Virtual
				cForma := "19"
...
Validaï¿½ï¿½o com a tabela 5.2 para enviar o codigo SEM CBENEF de acordo com a UF

@param  cUF 	- Estado que serï¿½ validado
...
Limpa os cï¿½digos ASCII faixa 127 a 255 que falham os EncodeUTF8
...
Verifica se a operaï¿½ï¿½o se trata de uma triangulaï¿½ï¿½o
...
Funï¿½ï¿½oï¿½paraï¿½queï¿½quandoï¿½mudarï¿½oï¿½cadastroï¿½deï¿½cliente referente ao grupo de destinatï¿½rioï¿½naï¿½tabelaï¿½AIFï¿½o mesmoï¿½busqueï¿½dadosï¿½daï¿½notaï¿½vinculada e retorna no array .ï¿½
@param  aDest 	 - Array com o destinatï¿½rio
	...
	SELECT max(AIF_DATA) AIF_DATA
		...
		if lDestVinc
			...
			If !Empty(aDestVinc)
				...
				aDest[04]  := aDestVinc[04] // - Nï¿½mero
				aDest[05]  := aDestVinc[05] // - Complemento
				aDest[06]  := aDestVinc[06] // - Bairro
				aDest[07]  := aDestVinc[07] // - Cï¿½digo do municï¿½pio
				aDest[08]  := aDestVinc[08] // - Nome do municï¿½pio
				aDest[09]  := aDestVinc[09] // - Sigla da UF
				aDest[10]  := aDestVinc[10] // - Cï¿½digo do CEP
				aDest[11]  := aDestVinc[11] // - Cï¿½digo do Paï¿½s
				aDest[12]  := aDestVinc[12] // - Nome do Paï¿½s
				aDest[13]  := aDestVinc[13] // - Telefone
				aDest[14]  := iif(EMPTY(aDestVinc[15]),'ISENTO',aDestVinc[15]) // - Inscriï¿½ï¿½o Estadual do Destinatï¿½rio
				aDest[15]  := aDestVinc[16] // - Inscriï¿½ï¿½o na SUFRAMA
				aDest[19]  := aDestVinc[17] // - Inscriï¿½ï¿½o Municipal do Tomador do Serviï¿½o
...
Funcao responsavel por determinar se ï¿½ um estorno de devoluï¿½ï¿½o 

@param  cTipo - Tipo do pedido de venda
@param  cCFOP - numero do CFOP utilizado

@return	lRet - .T. se ï¿½ operaï¿½ï¿½o de estorno de devoluï¿½ï¿½o/
				.F. se nï¿½o ï¿½ estorno de devoluï¿½ï¿½o
...
/*/{Protheus.doc} EstDevSeek
	Funï¿½ï¿½o responsavel por posicionar e verificar a integridade da operaï¿½ï¿½o 
	de estorno de devoluï¿½ï¿½o.
	@type  Static Function
	@author Felipe Sales Martinez
	@since 09/10/2020
	@version 12
	@param cAliasSD2 - alias com as informaï¿½ï¿½es do item da nota
	@return lRet: .T. posicionou e validou corretamente
			lRet: .F. problemas na operaï¿½ï¿½o
/*/
...
Funï¿½ï¿½o para retirada dos caracteres '(', ')' , '+', ' ' e '-'
...
Retorna de acordo com o indicador de presenï¿½a indica se pode ser informado
o indIntermed
@param		cIndPres, String, indicado de presenï¿½a
@param		cIntermediador, String, Codigo do intermediador da operacao de venda
@return		lRet, boleano, se ï¿½ necessario informar o IndIntermed ou nï¿½o
@author  	Felipe Sales Martinez
@since   	11/03/2021
@version 	1.0
/*/
...
//Retirar o parametro apos a data de entrada em produï¿½ï¿½o da NT 2020.006 (prevista para 01/09/2021)
if ( cIndPres $ "2,3,4,9" .or. (cIndPres == "1" .and. !empty(cIntermediador)) ) .and. date() >= cTod(SuperGetMv('MV_NT2006I',.F.,"05/04/2021"))
	if empty(cIntermediador)
		cIndIntermed := "0" //0=Operaï¿½ï¿½o sem intermediador (em site ou plataforma prï¿½pria)
	else
		cIndIntermed := "1" //1=Operaï¿½ï¿½o em site ou plataforma de terceiros (intermediadores/marketplace)
	endIf
endIf
...
@param		aNota, Array, Informaï¿½ï¿½es da nota
...
//TODO: se valor de Default deverar ser retirado apos entrada da NT2020.006 em produï¿½ï¿½o (prevista para 01/09/2021)
if empty(cIndPres)
	If aNota[5] == "N"
...
Retorna o conteï¿½do do parï¿½metro MV_NT2005 

@return		lRetorno	.T. - Informa tags ref. NT 2020.005  
						.F. = Nï¿½o informa

Tratamento deve ser retirado apï¿½s liberaï¿½ï¿½o em produï¿½ï¿½o
...
if lSpedCodOnu .and. allTrim(superGetMv("MV_NONUINF",,"0")) == "1" 
	...
	//modelo antigo apenas para compatibilidade - sem manutenï¿½ï¿½o
...
@param	cTipo		Tipo do item
		nPrcVen 	Valor unitï¿½rio do item
...
Local nTotal	:= 0 
Local lMvtot	:= SuperGetMV("MV_NFSETOT",,.F.) // Parï¿½metro para somar o desconto no valor total
